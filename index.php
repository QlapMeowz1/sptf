...
<?php 
$QuangLapHeader = new QuangLapHeader();
$QuangLapMusicList = new QuangLapMusicList();
$QuangLapHeader->CommonMethod();
$QuangLapMusicList->CommonMethod();
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="<?=$QuangLapHeader->description?>">
    <meta name="author" content="QuangLapStudio">
    <meta name="keywords"
        content="<?=$QuangLapHeader->keywords?>">
    <meta name="robots" content="index, follow">
    <meta property="og:type" content="website">
    <link rel="shortcut icon" href="<?=$QuangLapHeader->favicon?>?v=<?=rand(1,999)?>" type="image/x-icon">
    <meta property="og:title" content="<?=$QuangLapHeader->title?>">
    <meta property="og:url" content="//melmuop.site">
    <meta property="og:image" content="./res/v5/img/bg3.webp">
    <title><?=$QuangLapHeader->title?></title>
    <!--/ @StyleSheets /-->
...
<body class="BodyStyle">
    <div class="td-lock-screen">
        <section class="td-welcome">
            <div class="medias">
                <video class="item_video" autoplay loop muted playsinline  poster="/res/v5/thumbs/hutao.jpg" controls>
            ...
            <div class="infos">
                <div class="logo-web-title">
                    <a href="https://ibb.co/wZ4Ft0cW"><img class="logo-ws" src="https://i.ibb.co/NgKdRVTj/z7349439072340-ec0f77b8cbbb777262a197a61ba0bf4d.jpg" alt="z7349439072340-ec0f77b8cbbb777262a197a61ba0bf4d" border="0"></a>
    ...
    <div id="loading-box">
        <div class="loading-bg">
            <img class="loading-img entered loading" src="<?=$QuangLapHeader->favicon?>?v=<?=rand(1,999)?>" data-ws-status="loading">
    ...
    <main id="td-main">
        <nav id="nav" class="hide">
            <div class="td-popup" id="share_card">
                <div class="left">
                    <div class="title">Chia Sẻ Đến Mọi Người</div>
                ...
                <div class="right">
                    ...
                    <img class="avatar-nav"
                        src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://melmuop.site"
                        alt="Qr-code">
                </div>
            </div>
        </nav>
        <header id="header">
            <h2>
                <a href="#" class="site-icon"><?=$QuangLapHeader->namesite?></a>
            </h2>
        ...
        <section class="td-content">
            <div class="about-me">
                <div class="info-left">
                    <span class="tag"><?=$QuangLapHeader->bio1?></span>
                    <span class="tag"><?=$QuangLapHeader->bio2?></span>
                    <span class="tag"><?=$QuangLapHeader->bio3?></span>
                </div>
                <div class="avatar">
                    <img class="avatar-img" src="<?=$QuangLapHeader->avatar?>?v=<?=rand(1,999)?>" alt="Đinh Quang Lập">
                    <img class="crown" src="./res/v5/img/crown/mong-vuot-rong.png">
                    <!-- <img class="crown2" src="./res/v5/img/crown/vip-crown.png"> -->
                </div>
                <div class="info-right">
                    <span class="tag"><?=$QuangLapHeader->bio4?></span>
                    <span class="tag"><?=$QuangLapHeader->bio5?></span>
                    <span class="tag"><?=$QuangLapHeader->bio6?></span>
                </div>
            </div>
            <div class="padding" style="height:2em;"></div>
            <h2 class="HoVaTen__">
                <span id="userName" data-userName='<?= json_encode($QuangLapHeader->userName ?? []) ?>'></span>
            </h2>
            <div class="about-me-2">
                <button class="trigger"><?=$QuangLapHeader->trigger?></button>
                <button class="trigger"><?=$QuangLapHeader->bio1?></button>
                <button class="trigger"><?=$QuangLapHeader->bio2?></button>
                <button class="trigger"><?=$QuangLapHeader->bio3?></button>
                <button class="trigger"><?=$QuangLapHeader->bio4?></button>
                <button class="trigger"><?=$QuangLapHeader->bio5?></button>
                <button class="trigger"><?=$QuangLapHeader->bio6?></button>
            </div>
            <div class="padding" style="height:1em;"></div>
            <section id="hr-mod">
                <?php foreach ($QuangLapHeader->SocialNetworks as $network => $url): ?>
                            ...
                            <div class="nk-opt-set">
                                ...
                                <div class="nk-opt-list">
                                    <ul class="music_menu_list">
                                        <?php foreach ($QuangLapMusicList->songs as $song): ?>
                                        <li url="<?= $song['url'] ?>">
                                            <span class="name">
    ...
    <footer id="footer">
        <span>
            <a href="//melmuop.site" target="_blank">&copy; Copyright&nbsp;melmuop 2025</a>
        </span>
    </footer>
    <div class="time-now" id="real-time">00:00:00</div>
    <div id="Toast">Hevol LUV</div>
